...
("1.2","Fractions","Equivalent fractions and simplifying, mixed numbers, common denominators, all four operations, reciprocals, a fraction of a quantity, writing one number as a fraction of another, converting to decimals and percentages",F,CORE,["Fractions"]),
...
("1.6","Percentages","Converting between percentages, fractions and decimals, percentage of a quantity, one number as a percentage of another, percentage multipliers, increase and decrease, reverse percentages, compound interest and depreciation, repeated percentage change",B,CORE,["Percentages","Percentage Increase or Decrease","Compound Interest"]),
("1.7","Ratio and proportion","Ratio notation, simplifying and the form 1 : n, links between ratio and fractions, dividing a quantity in a ratio, unitary method, direct proportion, maps and scale diagrams",F,CORE,["Ratio","Proportion","Scale Factors","Maps and Scale Drawings"]),
("1.8","Degree of accuracy","Rounding integers to a given power of 10, rounding to decimal places and significant figures, estimating by rounding to 1 significant figure",F,CORE,["Rounding","Approximation and Estimation"]),
...
("2.8","Inequalities","Inequality symbols including double ended, open and closed intervals on a number line, solving linear inequalities, shading and identifying regions on a graph",F,CORE,["Inequalities","Inequalities on Graphs"]),
...
("3.3H","Harder graphs","Cubic, reciprocal, exponential and trigonometric graphs, transformations of y = f(x), gradients of curves by drawing a tangent, where two graphs intersect and how that solves an equation, circle equations",H,LEAVE,["Exponential and Trigonometric Graphs","Translations and Reflections of Functions","Circle Equations and Tangents","Graphs of Circles","Parallel or Perpendicular Lines"]),
...
("6.3","Probability","Probability language and scale, sample space, listing outcomes, Venn diagrams, complement, addition rule for mutually exclusive events, estimating probability from collected data, expected frequency",F,CORE,["Probability of Events","Probability Equations","Venn Diagrams"]),
